...
include("./GeneralDomainwallFermion/GeneralDomainwallFermion.jl")
...
function Dirac_operator(
    ...
    elseif parameters["Dirac_operator"] == "GeneralDomainwall"
        GeneralDomainwall_Dirac_operator(U, x, parameters)
    else
