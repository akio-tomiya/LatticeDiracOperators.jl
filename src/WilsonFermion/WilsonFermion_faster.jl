struct Wilson_Dirac_1storder_operator{Dim,T,fermion} <: Dirac_operator{Dim} where T <: AbstractGaugefields
    U::Array{T,1}
    μ::Int64
...
function Wilson_Dirac_1storder_operator(U::Array{<: AbstractGaugefields{NC,Dim},1},μ,x,boundarycondition) where {NC,Dim}
    xtype = typeof(x)
    num = 3
    ...
    return Wilson_Dirac_1storder_operator{Dim,T,xtype}(U,μ,boundarycondition,_temporary_fermi )
end

struct Wilson_Dirac_operator_faster{Dim,T,fermion} <: Wilson_Dirac_operators{Dim}  where T <: AbstractGaugefields
    U::Array{T,1}
...
"""
function LinearAlgebra.mul!(y::T1,A::Wilson_Dirac_operator_faster{Dim,T,fermion},x::T3) where {T1 <:AbstractFermionfields,T, Dim,fermion, T3 <:AbstractFermionfields}
    clear_fermion!(y)
...
function LinearAlgebra.mul!(y::T1,A::Adjoint_Wilson_operator_faster{Wilson_Dirac_operator_faster{Dim,T,fermion}},x::T3) where {T1 <:AbstractFermionfields,T, Dim,fermion, T3 <:AbstractFermionfields}
    clear_fermion!(y)
...
function LinearAlgebra.mul!(y::T1,A::Adjoint_Wilson_Dirac_1storder_operator{Wilson_Dirac_1storder_operator{Dim,T,fermion}},x::T3) where {T1 <:AbstractFermionfields,T, Dim,fermion, T3 <:AbstractFermionfields}
    if A.parent.μ == 1
        apply_Dirac_1storder_1_dagger!(y,x,A.parent.U,A.parent.boundarycondition,A.parent._temporary_fermi)
        
    elseif A.parent.μ == 2
        apply_Dirac_1storder_2_dagger!(y,x,A.parent.U,A.parent.boundarycondition,A.parent._temporary_fermi)
    elseif A.parent.μ == 3
        apply_Dirac_1storder_3_dagger!(y,x,A.parent.U,A.parent.boundarycondition,A.parent._temporary_fermi)        
    elseif A.parent.μ == 4
        apply_Dirac_1storder_4_dagger!(y,x,A.parent.U,A.parent.boundarycondition,A.parent._temporary_fermi)
    else
