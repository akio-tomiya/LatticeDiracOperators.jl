...
#=
# Provided by LatticeMatrices v1.1 in LinearAlgebras/linearalgebra_D.jl.
...
#=
# The corresponding dot implementation and reduction kernel are provided by
# LatticeMatrices v1.1. The local dot method above was already disabled.
...
#C = a*x
#=
# Provided by LatticeMatrices v1.1 in LinearAlgebras/mul.jl.
...
#=
# Duplicated by LatticeMatrices.Oneγ for μ = 1:4.  Keep the old source
# commented during the v1 transition; μ = 5 below remains LDO-specific.
...
#=
# Duplicated by the shifted-LatticeMatrix overload for LatticeMatrices.Oneγ.
...
#=
# Duplicated by LatticeMatrices.Oneγ.  Callers now use its three-argument
# mul! so no LatticeMatrix in-place kernel is needed for μ = 1:4.
