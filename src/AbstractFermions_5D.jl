abstract type AbstractFermionfields_5D{NC} <: AbstractFermionfields{NC,5} end

function Base.setindex!(
    x::AbstractFermionfields_5D{NC},
    v,
    i1,
    i2,
    i3,
            ...
            for i5 = 1:n5
                for i4 = 1:n4
                    for i3 = 1:n3
                        for i2 = 1:n2
                            @simd for i1 = 1:NC
                                a.w[iL].f[i1, i2, i3, i4, i5, i6] =
                                    b.w[iL].f[i1, i2, i3, i4, i5, i6]
                            end
                        end
                    end
                end
...
function LinearAlgebra.axpby!(
    ...
    X::T,
    b::Number,
    Y::AbstractFermionfields_5D{NC},
) where {NC,T<:AbstractFermionfields_5D}
    L5 = length(X.w)
