...
struct Wilson_GeneralDirac_FermiAction{Dim,Dirac,fermion,gauge} <:
    ...
    function Wilson_GeneralDirac_FermiAction(
    ...
    for i = 1:numterms
        ...
        for μ = 1:Dim
            ...
            for inum = 1:numderivatives
                ...
                #if coeff_i > 1e-15
                gaugefield_fermion_mul!(
                    temp1_f,
                    linkinfo_derivatives_right[inum],
                    U,
                    Xshifted,
                ...
                gaugefield_fermion_mul!(
                    temp0_f,
                    linkinfo_derivatives_leftdag[inum],
                    U,
                    Yshifted,
                    fermi_action._temporary_fermionfields,
                )
