...
function MDtest!(gauge_action, U, Dim, fermi_action, η, ξ)
    ...
    hist = open("thermalhistory_mobius_B545Ls4.txt", "w")

    if !ispath("mobiusB545Ls4")
        mkdir("mobiusB545Ls4"; mode=0o777)
    end
    ...
    for itrj = 1:numtrj
        ...
        flush(hist)
        filename = "mobiusB545Ls4/conf_mobius_88844_B545M-1.9m0.02_b1c1_$(lpad(string(itrj), 4, '0')).ildg"
...
import .mobiusdomainwall: test_mobiusdomain
test_mobiusdomain()